...
public class ChinaFriendship : Label {
    public override void _Process(float delta) {
        Text = "Diplomatic Friendship: " + Global.China.Friendship.ToString("0.0") + "%";
        // ally
        if (Global.China.Friendship > 60) {
            this.AddColorOverride("font_color", new Color(0.242f, 0.726f, 0.285f, 1));
        // enemy
        } else if (Global.China.Friendship < 40) {
